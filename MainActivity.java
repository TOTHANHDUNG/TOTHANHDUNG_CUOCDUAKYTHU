    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CountDownTimer countDownTimer = new CountDownTimer(60000,300) {
            ...
            public void onTick(long l) {
                ...
                int one=radom.nextInt(number);
                int two=radom.nextInt(number);
                int three=radom.nextInt(number);

                if (skOne.getProgress()>=skOne.getMax()){
                    this.cancel();
                    ibtnPlay.setVisibility(View.VISIBLE);
                    Toast.makeText(MainActivity.this, "GOKU IS WINER", Toast.LENGTH_SHORT).show();
                    //Kiem tra dat cuoc
                    if (cbOne.isChecked()){
                        soDiem +=10;
                ...
                if (skTwo.getProgress()>=skTwo.getMax()){
                    this.cancel();
                    ibtnPlay.setVisibility(View.VISIBLE);
                    Toast.makeText(MainActivity.this, "TANJIRO IS WINER", Toast.LENGTH_SHORT).show();
                    //Kiem tra dat cuoc
                    if (cbTwo.isChecked()){
                        soDiem +=10;
                        Toast.makeText(MainActivity.this, "Ban doan chinh xac!", Toast.LENGTH_SHORT).show();
                ...
                if (skThree.getProgress()>=skThree.getMax()){
                    this.cancel();
                    ibtnPlay.setVisibility(View.VISIBLE);
                    Toast.makeText(MainActivity.this, "VEGETA IS WINER", Toast.LENGTH_SHORT).show();
                    //Kiem tra dat cuoc
